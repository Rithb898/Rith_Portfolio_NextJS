...
export default function ProjectSection() {
  ...
  return (
    <div
      className='min-h-screen bg-[#04081A] py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden'
      id='projects'
    >
      <ModernGridPattern />
                ...
                <div className='md:w-1/2 p-8 relative backdrop-blur-xs bg-[#0a1428]/30 group-hover:bg-[#081020]/50 transition-all duration-300'>
                  ...
                  <div className='flex gap-4 flex-wrap'>
                    <LinkPreview
                      ...
                      className='font-bold'
                    >
                      <div className='flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 text-white hover:text-cyan-400 hover:bg-slate-900/70 transition-all border border-slate-700/50'>
                        <FaGithub size={18} />
                        <span>View Code</span>
                      </div>
                    </LinkPreview>
                    <LinkPreview url={project.links.demo} className='font-bold'>
                      <div className='flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 text-white hover:text-emerald-400 hover:bg-slate-900/70 transition-all border border-slate-700/50'>
